  ...
  return (
    <div className={style.sidebar}>
      <div className={style.headSidebar}>
        ...
        <div className={style.numberReview}>
          ...
          <p>4.9</p>
          <p>.</p>
          <p className={style.textDecoration}>142 reviews</p>
        </div>
      </div>
      <div className={style.changeColor}>
        <p>Color: Black</p>
      </div>
      <div className={style.themeColor}>
      ...
      <div className={`grid grid-cols-4 gap-6 ${style.sizeType}`}>
        <button>
          XS
        </button>
        <button>
