...
function Modal({toggleModal}) {
    return (
        <div className={style.bgDarkModal} onClick={toggleModal}>
            <div className={style.modals}>
                <div className={style.headModal}>
                    <button onClick={toggleModal}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
