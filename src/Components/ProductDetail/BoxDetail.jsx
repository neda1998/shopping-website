...
function BoxDetail({ title, detail, customBackground }) {
    const icons = [{
        id: 1, svg: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        id: 2, svg: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        id: 3, svg: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        id: 4, svg: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className={style.boxDetail} style={{ backgroundColor: customBackground }}>
            {icons.map((icon, id) => {
                return (
                    <button key={id}>
                        {icon.svg}
