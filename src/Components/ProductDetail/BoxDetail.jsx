...
function BoxDetail({ customBackground }) {
    const icons = [{
        ...
        </svg>, title: "Free shipping", detail: "On orders over $50.00", backGround:"#FEF2F2"
    },
    {
        id: 2, icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg>, title: "Very easy to return", detail: "Just phone number."  , backGround:"#F0F9FF"
    },
    {
        id: 3, icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg>, title: "Nationwide Delivery", detail: "Fast delivery nationwide.", backGround:"#F0FDF4"
    },
    {
        id: 4, icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg>, title: "Refunds policy", detail: "60 days return for any reason", backGround:"#FFFBEB"
    },
    ]
    return (
        icons.map(values => {
            const { id, title, detail, icon, backGround } = values;
            return (
                <div className={style.boxDetail} style={{backgroundColor: backGround}} key={id}>
                    <button>
                        {icon}
                    </button>
                    <h6>{title}</h6>
